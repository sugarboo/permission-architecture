...
const data = computed(() => ({
  ...
  versions: {
    policy_version: database.value.policyVersion,
    catalog_version: database.value.catalogVersion
  },
  recentAudit: database.value.audits.slice(0, 6)
}))
...
const stats = computed(() => [
  ...
  { label: '稳定业务资源', value: data.value?.counts?.resources || 0, icon: 'i-lucide-boxes', color: '#18a77b', tint: '#eaf9f4' },
...
<template>
  <div>
    <PageHeader title="把授权语言还给业务" description="运营人员分配“查看客户、审批采购单”等稳定资源；前后端共用同一资源码，前端负责体验，后端负责最终放行。">
      ...
      <section class="panel">
        ...
        <div class="panel-body">
          <div class="detail-grid">
            ...
            <div class="detail-cell"><span>授权资源</span><b>{{ data?.counts?.resources || 0 }} 个</b></div>
